...
if __name__ == "__main__":
    ...
    for i in range(3):
        ...
        time_attack.append(detection_time)
        ...
        if IP!="NULL":
            ...
            print(f"Temps de detection flow normal  : {detection_time} ")
        time_ok.append(detection_time)
    print("Moyenne detection attack  : ", sum(time_attack)/3)
    print("Moyenne detection OK  : ", sum(time_ok)/3)
